...
The website uses Google Analytics in order for me to have an idea of who visits the website. I am not the biggest fan of these kinds of services, but, unfortunately, the Wowchemy builder only natively supports Google Analytics and Microsoft Clarity. I went for Google's option because I am more familiar with it, but may consider switching to Microsoft in the future. I am also considering researching if there's a why to use a more privacy-friendly service.
